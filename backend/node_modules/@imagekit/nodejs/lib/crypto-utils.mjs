 ...
 */
export function createHmacSha1(key, data) {
    if (!crypto || typeof crypto.createHmac !== 'function') {
        throw new ImageKitError('URL signing requires Node.js crypto module which is not available in this runtime. ' +
    ...
    try {
        ...
        throw new ImageKitError(`Failed to generate HMAC-SHA1 signature: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
