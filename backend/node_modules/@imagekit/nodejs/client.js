...
class ImageKit {
    ...
    constructor({ baseURL = (0, env_1.readEnv)('IMAGE_KIT_BASE_URL'), privateKey = (0, env_1.readEnv)('IMAGEKIT_PRIVATE_KEY'), password = (0, env_1.readEnv)('OPTIONAL_IMAGEKIT_IGNORES_THIS') ?? 'do_not_set', webhookSecret = (0, env_1.readEnv)('IMAGEKIT_WEBHOOK_SECRET') ?? null, ...opts } = {}) {
        ...
        const customHeadersEnv = (0, env_1.readEnv)('IMAGE_KIT_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildBody({ options }) {
        ...
        if (!body) {
            ...
            if (body == null && 'body' in options) {
                return tslib_1.__classPrivateFieldGet(this, _ImageKit_encoder, "f").call(this, { body, headers: (0, headers_1.buildHeaders)([rawHeaders]) });
            }
