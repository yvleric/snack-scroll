...
exports.SavedExtensions = void 0;
const resource_1 = require("../core/resource.js");
const headers_1 = require("../internal/headers.js");
const path_1 = require("../internal/utils/path.js");
class SavedExtensions extends resource_1.APIResource {
    /**
     ...
     */
    get(id, options) {
        return this._client.get((0, path_1.path) `/v1/saved-extensions/${id}`, options);
    }
    /**
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/v1/saved-extensions/${id}`, { body, ...options });
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/v1/saved-extensions/${id}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
}
exports.SavedExtensions = SavedExtensions;
//# sourceMappingURL=saved-extensions.js.map